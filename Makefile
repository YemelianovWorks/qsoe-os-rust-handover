...
ifneq ($(QSOE_RUST_TM_ELF),1)
$(error QSOE_RUST_TM_ELF must be 1 after C tm_elf retirement)
endif
ifneq ($(QSOE_RUST_TM_PROCFS),1)
$(error QSOE_RUST_TM_PROCFS must be 1 after C tm_procfs retirement)
endif
ifneq ($(QSOE_RUST_TM_SCRIPT),1)
$(error QSOE_RUST_TM_SCRIPT must be 1 after C tm_script retirement)
endif
ifneq ($(QSOE_RUST_TM_SYSCFG),1)
$(error QSOE_RUST_TM_SYSCFG must be 1 after C tm_syscfg retirement)
endif
ifneq ($(QSOE_RUST_TM_SYSMAP),1)
$(error QSOE_RUST_TM_SYSMAP must be 1 after C tm_sysmap retirement)
endif
...
.PHONY: all prepare component-overrides clean nvme nvme-populate virtio fsqrv-image tree \
        ...
        tm-cpio-evidence tm-cpio-runtime-smoke tm-cpio-rc-smoke tm-cred-evidence tm-cred-runtime-smoke tm-cred-rc-smoke tm-cred-rc-rollback-smoke tm-elf-evidence tm-elf-runtime-smoke tm-elf-rc-smoke tm-fdt-evidence tm-fdt-runtime-smoke tm-fdt-rc-smoke tm-fdt-rc-rollback-smoke tm-pathmgr-evidence tm-pathmgr-runtime-smoke tm-pathmgr-rc-smoke tm-pathmgr-rc-rollback-smoke tm-procfs-evidence tm-providers-evidence tm-rsrcdb-evidence tm-rsrcdb-runtime-smoke tm-rsrcdb-rc-smoke tm-rsrcdb-rc-rollback-smoke tm-script-evidence tm-script-runtime-smoke tm-script-rc-smoke \
        tm-syscfg-evidence tm-syscfg-runtime-smoke tm-syscfg-rc-smoke tm-sysmap-evidence tm-sysmap-runtime-smoke tm-sysmap-rc-smoke tm-sysfs-evidence tm-sysfs-runtime-smoke tm-sysfs-rc-smoke tm-pseudodev-evidence tm-pseudodev-runtime-smoke tm-pseudodev-rc-smoke tm-pseudodev-rc-rollback-smoke \
        ...
        container-tm-cpio-evidence container-tm-cpio-runtime-smoke container-tm-cpio-rc-smoke container-tm-cred-evidence container-tm-cred-runtime-smoke container-tm-cred-rc-smoke container-tm-cred-rc-rollback-smoke container-tm-elf-evidence container-tm-elf-runtime-smoke container-tm-elf-rc-smoke container-tm-fdt-evidence container-tm-fdt-runtime-smoke container-tm-fdt-rc-smoke container-tm-fdt-rc-rollback-smoke container-tm-pathmgr-evidence container-tm-pathmgr-runtime-smoke container-tm-pathmgr-rc-smoke container-tm-pathmgr-rc-rollback-smoke container-tm-procfs-evidence container-tm-providers-evidence \
        ...
        container-tm-sysmap-evidence container-tm-sysmap-runtime-smoke container-tm-sysmap-rc-smoke container-tm-sysfs-evidence container-tm-sysfs-runtime-smoke container-tm-sysfs-rc-smoke container-tm-pseudodev-evidence container-tm-pseudodev-runtime-smoke container-tm-pseudodev-rc-smoke container-tm-pseudodev-rc-rollback-smoke \
...
tm-cpio-rc-smoke:
	@scripts/tm-cpio-rc-smoke.sh

tm-cred-evidence:
	@scripts/tm-cred-evidence.sh

tm-cred-runtime-smoke:
	@scripts/tm-cred-runtime-smoke.sh

tm-cred-rc-smoke:
	@scripts/tm-cred-rc-smoke.sh

tm-cred-rc-rollback-smoke:
...
tm-fdt-rc-smoke:
	@scripts/tm-fdt-rc-smoke.sh

tm-fdt-rc-rollback-smoke:
	@TM_FDT_RC_ROLLBACK=1 scripts/tm-fdt-rc-smoke.sh

tm-pathmgr-evidence:
	@scripts/tm-pathmgr-evidence.sh

tm-pathmgr-runtime-smoke:
	@scripts/tm-pathmgr-runtime-smoke.sh

tm-pathmgr-rc-smoke:
	@scripts/tm-pathmgr-rc-smoke.sh

tm-pathmgr-rc-rollback-smoke:
...
tm-sysfs-rc-smoke:
	@scripts/tm-sysfs-rc-smoke.sh

tm-pseudodev-evidence:
	@scripts/tm-pseudodev-evidence.sh

tm-pseudodev-runtime-smoke:
	@scripts/tm-pseudodev-runtime-smoke.sh

tm-pseudodev-rc-smoke:
	@scripts/tm-pseudodev-rc-smoke.sh

tm-pseudodev-rc-rollback-smoke:
...
container-tm-cpio-rc-smoke:
	@scripts/container-toolchain.sh run make tm-cpio-rc-smoke

container-tm-cred-evidence:
	@scripts/container-toolchain.sh run make tm-cred-evidence

container-tm-cred-runtime-smoke:
	@scripts/container-toolchain.sh run make tm-cred-runtime-smoke

container-tm-cred-rc-smoke:
	@scripts/container-toolchain.sh run make tm-cred-rc-smoke

container-tm-cred-rc-rollback-smoke:
	@scripts/container-toolchain.sh run make tm-cred-rc-rollback-smoke
...
container-tm-elf-rc-smoke:
	@scripts/container-toolchain.sh run make tm-elf-rc-smoke
...
container-tm-fdt-rc-smoke:
	@scripts/container-toolchain.sh run make tm-fdt-rc-smoke

container-tm-fdt-rc-rollback-smoke:
	@scripts/container-toolchain.sh run make tm-fdt-rc-rollback-smoke

container-tm-pathmgr-evidence:
	@scripts/container-toolchain.sh run make tm-pathmgr-evidence

container-tm-pathmgr-runtime-smoke:
	@scripts/container-toolchain.sh run make tm-pathmgr-runtime-smoke

container-tm-pathmgr-rc-smoke:
	@scripts/container-toolchain.sh run make tm-pathmgr-rc-smoke

container-tm-pathmgr-rc-rollback-smoke:
	@scripts/container-toolchain.sh run make tm-pathmgr-rc-rollback-smoke
...
container-tm-script-rc-smoke:
	@scripts/container-toolchain.sh run make tm-script-rc-smoke
...
container-tm-syscfg-rc-smoke:
	@scripts/container-toolchain.sh run make tm-syscfg-rc-smoke
...
container-tm-sysfs-rc-smoke:
	@scripts/container-toolchain.sh run make tm-sysfs-rc-smoke

container-tm-pseudodev-evidence:
	@scripts/container-toolchain.sh run make tm-pseudodev-evidence

container-tm-pseudodev-runtime-smoke:
	@scripts/container-toolchain.sh run make tm-pseudodev-runtime-smoke

container-tm-pseudodev-rc-smoke:
	@scripts/container-toolchain.sh run make tm-pseudodev-rc-smoke

container-tm-pseudodev-rc-rollback-smoke:
	@scripts/container-toolchain.sh run make tm-pseudodev-rc-rollback-smoke
