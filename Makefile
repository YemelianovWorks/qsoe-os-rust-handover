...
ifneq ($(QSOE_RUST_TM_CRED),1)
$(error QSOE_RUST_TM_CRED must be 1 after C tm_cred retirement)
endif
ifneq ($(QSOE_RUST_TM_ELF),1)
$(error QSOE_RUST_TM_ELF must be 1 after C tm_elf retirement)
endif
ifneq ($(QSOE_RUST_TM_FDT),1)
$(error QSOE_RUST_TM_FDT must be 1 after C tm_fdt retirement)
endif
ifneq ($(QSOE_RUST_TM_PATHMGR),1)
$(error QSOE_RUST_TM_PATHMGR must be 1 after C tm_pathmgr retirement)
endif
ifneq ($(QSOE_RUST_TM_PROCFS),1)
$(error QSOE_RUST_TM_PROCFS must be 1 after C tm_procfs retirement)
endif
ifneq ($(QSOE_RUST_TM_PSEUDODEV),1)
$(error QSOE_RUST_TM_PSEUDODEV must be 1 after C tm_pseudodev retirement)
endif
ifneq ($(QSOE_RUST_TM_RSRCDB),1)
$(error QSOE_RUST_TM_RSRCDB must be 1 after C tm_rsrcdb retirement)
endif
...
.PHONY: all prepare component-overrides clean nvme nvme-populate virtio fsqrv-image tree \
        ...
        check-tm-cpio-model check-tm-cred-model check-tm-elf-model check-tm-pathmgr-model check-tm-procfs-model check-tm-rsrcdb-model \
...
rust-tm-log-provider:
	@QSOE_RUST_TM_LOG=1 \
	    scripts/build-rust-tm-providers.sh build/rust/tm-log/libqsoe_tm_log.a
...
container-rust-tm-log-provider:
	@scripts/container-toolchain.sh run make rust-tm-log-provider
...
container-tm-log-evidence:
	@scripts/container-toolchain.sh run make tm-log-evidence
...
.PHONY: spawn-loader-proto-c-evidence container-spawn-loader-proto-c-evidence container-spawn-loader-admit-c-evidence container-spawn-loader-map-c-evidence container-spawn-loader-auxv-c-evidence container-spawn-loader-entry-c-evidence container-spawn-tcb-handoff-c-evidence spawn-publication-c-evidence container-spawn-publication-c-evidence spawn-objcnode-c-evidence container-spawn-objcnode-c-evidence

spawn-loader-proto-c-evidence:
	@scripts/spawn-loader-proto-c-evidence.sh

container-spawn-loader-proto-c-evidence:
	@scripts/container-toolchain.sh run make spawn-loader-proto-c-evidence

spawn-loader-admit-c-evidence:
	@scripts/spawn-loader-admit-c-evidence.sh

container-spawn-loader-admit-c-evidence:
	@scripts/container-toolchain.sh run make spawn-loader-admit-c-evidence

spawn-loader-map-c-evidence:
	@scripts/spawn-loader-map-c-evidence.sh

container-spawn-loader-map-c-evidence:
	@scripts/container-toolchain.sh run make spawn-loader-map-c-evidence

spawn-loader-auxv-c-evidence:
	@scripts/spawn-loader-auxv-c-evidence.sh
...
spawn-tcb-handoff-c-evidence:
	@scripts/spawn-tcb-handoff-c-evidence.sh
...
spawn-objcnode-c-evidence:
	@scripts/spawn-objcnode-c-evidence.sh

container-spawn-objcnode-c-evidence:
	@scripts/container-toolchain.sh run make spawn-objcnode-c-evidence

.PHONY: spawn-argpack-c-evidence container-spawn-argpack-c-evidence

spawn-argpack-c-evidence:
	@scripts/spawn-argpack-c-evidence.sh
