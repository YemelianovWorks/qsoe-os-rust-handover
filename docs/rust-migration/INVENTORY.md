...
| `libtaskman` | 23 | 3,013 | Best source of host-testable task-manager modules. `tm_procfs` is Rust-default RC and `tm_cred` is Rust opt-in; more candidates are tracked in #142-#153. |
...
| Component issues | 8 | Components with concrete Rust artifacts or RC evidence. |
| Backlog, retirement, and inventory issues | 14 | Remaining candidates, deferred areas, retirement gate, and this inventory. |
...
1. Use #142-#149, #151, and #153 for remaining small task-manager pilots. Prefer
