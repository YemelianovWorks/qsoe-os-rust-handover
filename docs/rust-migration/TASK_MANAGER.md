...
| --- | --- | --- | --- |
| CPIO archive model | `libtaskman/src/cpio.c`, `libtaskman/include/tm_cpio.h` | Pure `newc` walking, symlink resolution, directory iteration, and existence checks over caller-owned bytes. | Medium: boot archive lookup is spawn-adjacent. |
...
| Credentials policy | `libtaskman/src/cred.c`, `libtaskman/include/tm_cred.h` | Pure cwd, umask, uid/gid mutation, and permission checks. | Low-medium: process semantics, not boot spawn. |
