...
apply_patch_if_possible_or_present lq lq-taskman-spawn-loader-proto-seam.patch \
    "$ROOT/lq/taskman/proc/spawn.c" \
    'tm_loader_proto'
apply_patch_if_possible_or_present lq lq-taskman-spawn-loader-admit-seam.patch \
    "$ROOT/lq/taskman/proc/spawn.c" \
    'tm_loader_admit'
...
apply_patch_if_possible_or_present lq lq-taskman-spawn-loader-auxv-seam.patch \
    "$ROOT/lq/taskman/proc/spawn.c" \
    'tm_loader_auxv_plan'
apply_patch_if_possible_or_present lq lq-taskman-spawn-loader-entry-seam.patch \
    "$ROOT/lq/taskman/proc/spawn.c" \
    'tm_loader_entry_plan'
apply_patch_if_possible_or_present lq lq-taskman-spawn-tcb-handoff-seam.patch \
    "$ROOT/lq/taskman/proc/spawn.c" \
    'tm_tcb_handoff_plan'
apply_patch_if_possible_or_present lq lq-taskman-spawn-publication-seam.patch \
    "$ROOT/lq/taskman/proc/spawn.c" \
    'tm_spawn_publication_plan'
apply_patch_if_possible_or_present lq lq-taskman-spawn-objcnode-seam.patch \
    "$ROOT/lq/taskman/proc/spawn.c" \
    'tm_spawn_objcnode_plan'
