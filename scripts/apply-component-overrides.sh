...
# per-component Rust archive paths. Normalize those to the top-level archive
# audited by scripts/tm-procfs-evidence.sh.
apply_patch_if_possible nq nq-taskman-rust-tm-procfs-root-path.patch
apply_patch_if_possible lq lq-taskman-rust-tm-procfs-root-path.patch
