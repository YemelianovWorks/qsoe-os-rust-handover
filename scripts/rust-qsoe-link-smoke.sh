#!/usr/bin/env bash
#
# Link the minimal Rust staticlib behind QSOE crt0/libc as a smoke test.
...
OUT="$OUTDIR/qsoe-minimal-rs.elf"
...
STATICLIB="$CARGO_TARGET_DIR/$RUST_TARGET/release/libqsoe_minimal_rs.a"
